...
args_settings_json = f"{SCRIPT_DIR}/settings.json"

with open(args_settings_json) as file:
...
is_gamepass_game = json_data["is_gamepass_game"]
...
def open_settings():
    os.system(f"start {SCRIPT_DIR}/settings.json")
