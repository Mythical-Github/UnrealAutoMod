...
def cli_logic():
    ...
    add_entry_to_alt_exe_entry_parser = unreal_auto_mod_parser.add_parser(name=alt_exe_parser_name,
                                                                          help=alt_exe_parser_help,
                                                                          description=alt_exe_parser_description)
    ...
    rm_ae_help = ''
    rm_ae_description = ''
    remove_entry_from_alt_exe_entry_parser = unreal_auto_mod_parser.add_parser(name=rm_ae_name, help=rm_ae_help,
                                                                               description=rm_ae_description)
    ...
    ss_ae_help = ''
    ss_ae_description = ''
    set_script_state_in_alt_exe_entry_parser = unreal_auto_mod_parser.add_parser(name=ss_ae_name, help=ss_ae_help,
                                                                                 description=ss_ae_description)
    ...
    ap_ae_help = ''
    ap_ae_description = ''
    set_alt_exe_path_in_alt_exe_entry_parser = unreal_auto_mod_parser.add_parser(name=ap_ae_name, help=ap_ae_help,
                                                                                 description=ap_ae_description)
    ...
    em_ae_help = ''
    em_ae_description = ''
    set_exec_mode_in_alt_exe_entry_parser = unreal_auto_mod_parser.add_parser(name=em_ae_name, help=em_ae_help,
                                                                              description=em_ae_description)
    ...
    aa_ae_help = ''
    aa_ae_description = ''
    add_args_in_alt_exe_entry_parser = unreal_auto_mod_parser.add_parser(name=aa_ae_name, help=aa_ae_help,
                                                                         description=aa_ae_description)
    ...
    remove_args_in_alt_exe_entry_parser = unreal_auto_mod_parser.add_parser(name=rm_args_ae_name, help=rm_args_ae_help,
                                                                            description=rm_args_ae_description)
    ...
    owd_help = ''
    owd_description = ''
    override_working_dir_parser = unreal_auto_mod_parser.add_parser(name=owd_name, help=owd_help,
                                                                    description=owd_description)
    ...
    am_aun_help = ''
    am_aun_description = ''
    use_alt_method_in_alt_uproject_parser = unreal_auto_mod_parser.add_parser(name=am_aun_name, help=am_aun_help,
                                                                              description=am_aun_description)
    ...
    am_augn_help = ''
    am_augn_description = ''
    alt_method_alt_uproject_name_parser = unreal_auto_mod_parser.add_parser(name=am_augn_name, help=am_augn_help,
                                                                            description=am_augn_description)
    ...
    rpp_help = ''
    rpp_description = ''
    repak_path_in_repak_info_parser = unreal_auto_mod_parser.add_parser(name=rpp_name, help=rpp_help,
                                                                        description=rpp_description)
    ...
    rpo_help = ''
    rpo_description = ''
    override_automatic_version_finding_in_repak_info_parser = unreal_auto_mod_parser.add_parser(name=rpo_name,
                                                                                                help=rpo_help,
                                                                                                description=rpo_description)
    override_automatic_version_finding_in_repak_info_parser.add_argument('settings_json_path',
    ...
    rpv_help = ''
    rpv_description = ''
    repak_version_in_repak_info_parser = unreal_auto_mod_parser.add_parser(name=rpv_name, help=rpv_help,
                                                                           description=rpv_description)
    ...
    ei_ued_help = ''
    ei_ued_description = ''
    engine_info_unreal_engine_dir_parser = unreal_auto_mod_parser.add_parser(name=ei_ued_name, help=ei_ued_help,
                                                                             description=ei_ued_description)
    ...
    ei_uep_help = ''
    ei_uep_description = ''
    engine_info_unreal_engine_project_parser = unreal_auto_mod_parser.add_parser(name=ei_uep_name, help=ei_uep_help,
                                                                                 description=ei_uep_description)
    ...
    ei_te_help = ''
    ei_te_description = ''
    toggle_engine_parser = unreal_auto_mod_parser.add_parser(name=ei_te_name, help=ei_te_help,
                                                             description=ei_te_description)
    ...
    ei_rsfu_help = ''
    ei_rsfu_description = ''
    toggle_engine_parser = unreal_auto_mod_parser.add_parser(name=ei_rsfu_name, help=ei_rsfu_help,
                                                             description=ei_rsfu_description)
    toggle_engine_parser.add_argument('settings_json_path', help='Path to settings.json')
    toggle_engine_parser.add_argument('override_value', help='true/false string value')
    ...
    ei_aela_help = ''
    ei_aela_description = ''
    add_engine_args_parser = unreal_auto_mod_parser.add_parser(name=ei_aela_name, help=ei_aela_help,
                                                               description=ei_aela_description)
    ...
    ei_rela_help = ''
    ei_rela_description = ''
    add_engine_args_parser = unreal_auto_mod_parser.add_parser(name=ei_rela_name, help=ei_rela_help,
                                                               description=ei_rela_description)
    add_engine_args_parser.add_argument('settings_json_path', help='Path to settings.json')
    add_engine_args_parser.add_argument('engine_args', help='one or more string args')
    ...
    ei_aeca_help = ''
    ei_aeca_description = ''
    cook_and_packaging_parser = unreal_auto_mod_parser.add_parser(name=ei_aeca_name, help=ei_aeca_help,
                                                                  description=ei_aeca_description)
    ...
    ei_reca_help = ''
    ei_reca_description = ''
    cook_and_packaging_args_parser = unreal_auto_mod_parser.add_parser(name=ei_reca_name, help=ei_reca_help,
                                                                       description=ei_reca_description)
    ...
    ei_uuvc_help = ''
    ei_uuvc_description = ''
    use_unversioned_cooked_content_parser = unreal_auto_mod_parser.add_parser(name=ei_uuvc_name, help=ei_uuvc_help,
                                                                              description=ei_uuvc_description)
    ...
    ei_cusv_help = ''
    ei_cusv_description = ''
    clear_uproject_saved_cooked_dir_before_tests_parser = unreal_auto_mod_parser.add_parser(name=ei_cusv_name,
                                                                                            help=ei_cusv_help,
                                                                                            description=ei_cusv_description)
    ...
    ei_abu_help = ''
    ei_abu_description = ''
    always_build_project_parser = unreal_auto_mod_parser.add_parser(name=ei_abu_name, help=ei_abu_help,
                                                                    description=ei_abu_description)
    ...
    ei_oavf_help = ''
    ei_oavf_description = ''
    override_automatic_version_finding_parser = unreal_auto_mod_parser.add_parser(name=ei_oavf_name, help=ei_oavf_help,
                                                                                  description=ei_oavf_description)
    ...
    unreal_engine_major_version_parser = unreal_auto_mod_parser.add_parser(name=ei_ue_maj_v_name, help=ei_ue_maj_v_help,
                                                                           description=ei_ue_maj_v_description)
    ...
    unreal_engine_minor_version_parser = unreal_auto_mod_parser.add_parser(name=ei_ue_min_v_name, help=ei_ue_min_v_help,
                                                                           description=ei_ue_min_v_description)
    ...
    gi_gp_help = ''
    gi_gp_description = ''
    game_path_parser = unreal_auto_mod_parser.add_parser(name=gi_gp_name, help=gi_gp_help,
                                                         description=gi_gp_description)
    ...
    gi_glt_help = ''
    gi_glt_description = ''
    game_launch_type_parser = unreal_auto_mod_parser.add_parser(name=gi_glt_name, help=gi_glt_help,
                                                                description=gi_glt_description)
    ...
    override_automatic_launcher_parser = unreal_auto_mod_parser.add_parser(name=gi_oalef_name, help=gi_oalef_help,
                                                                           description=gi_oalef_description)
    ...
    gi_glp_help = ''
    gi_glp_description = ''
    game_launcher_path_parser = unreal_auto_mod_parser.add_parser(name=gi_glp_name, help=gi_glp_help,
                                                                  description=gi_glp_description)
    ...
    gi_gid_help = ''
    gi_gid_description = ''
    game_id_parser = unreal_auto_mod_parser.add_parser(name=gi_gid_name, help=gi_gid_help,
                                                       description=gi_gid_description)
    ...
    gi_slg_help = ''
    gi_slg_description = ''
    skip_launching_game_parser = unreal_auto_mod_parser.add_parser(name=gi_slg_name, help=gi_slg_help,
                                                                   description=gi_slg_description)
    ...
    override_automatic_window_title_finding_parser = unreal_auto_mod_parser.add_parser(name=gi_oawtf_name,
                                                                                       help=gi_oawtf_help,
                                                                                       description=gi_oawtf_description)
    ...
    gi_wtos_help = ''
    gi_wtos_description = ''
    window_title_override_string_parser = unreal_auto_mod_parser.add_parser(name=gi_wtos_name, help=gi_wtos_help,
                                                                            description=gi_wtos_description)
    ...
    add_params_to_game_launch_params_parser = unreal_auto_mod_parser.add_parser(name=gi_apglp_name, help=gi_apglp_help,
                                                                                description=gi_apglp_description)
    ...
    remove_params_from_game_launch_params_parser = unreal_auto_mod_parser.add_parser(name=gi_rpglp_name,
                                                                                     help=gi_rpglp_help,
                                                                                     description=gi_rpglp_description)
    ...
    pki_acg_help = ''
    pki_acg_description = ''
    auto_close_game_parser = unreal_auto_mod_parser.add_parser(name=pki_acg_name, help=pki_acg_help,
                                                               description=pki_acg_description)
    ...
    pki_ae_help = ''
    pki_ae_description = ''
    add_pki_entry_parser = unreal_auto_mod_parser.add_parser(name=pki_ae_name, help=pki_ae_help,
                                                             description=pki_ae_description)
    ...
    pki_re_help = ''
    pki_re_description = ''
    remove_pki_entry_parser = unreal_auto_mod_parser.add_parser(name=pki_re_name, help=pki_re_help,
                                                                description=pki_re_description)
    ...
    pki_pn_help = ''
    pki_pn_description = ''
    process_name_parser = unreal_auto_mod_parser.add_parser(name=pki_pn_name, help=pki_pn_help,
                                                            description=pki_pn_description)
    ...
    pki_uss_help = ''
    pki_uss_description = ''
    pki_use_substring_check_parser = unreal_auto_mod_parser.add_parser(name=pki_uss_name, help=pki_uss_help,
                                                                       description=pki_uss_description)
    ...
    pki_ss_help = ''
    pki_ss_description = ''
    pki_script_state_parser = unreal_auto_mod_parser.add_parser(name=pki_ss_name, help=pki_ss_help,
                                                                description=pki_ss_description)
    ...
    amw_ae_help = ''
    amw_ae_description = ''
    awm_add_entry_parser = unreal_auto_mod_parser.add_parser(name=amw_ae_name, help=amw_ae_help,
                                                             description=amw_ae_description)
    ...
    amw_re_help = ''
    amw_re_description = ''
    amw_re_parser = unreal_auto_mod_parser.add_parser(name=amw_re_name, help=amw_re_help,
                                                      description=amw_re_description)
    ...
    amw_wn_help = ''
    amw_wn_description = ''
    amw_wn_parser = unreal_auto_mod_parser.add_parser(name=amw_wn_name, help=amw_wn_help,
                                                      description=amw_wn_description)
    ...
    amw_uss_help = ''
    amw_uss_description = ''
    amw_uss_parser = unreal_auto_mod_parser.add_parser(name=amw_uss_name, help=amw_uss_help,
                                                       description=amw_uss_description)
    ...
    amw_wb_help = ''
    amw_wb_description = ''
    amw_wb_parser = unreal_auto_mod_parser.add_parser(name=amw_wb_name, help=amw_wb_help,
                                                      description=amw_wb_description)
    ...
    amw_ss_help = ''
    amw_ss_description = ''
    amw_ss_parser = unreal_auto_mod_parser.add_parser(name=amw_ss_name, help=amw_ss_help,
                                                      description=amw_ss_description)
    ...
    amw_mi_help = ''
    amw_mi_description = ''
    amw_mi_parser = unreal_auto_mod_parser.add_parser(name=amw_mi_name, help=amw_mi_help,
                                                      description=amw_mi_description)
    ...
    amw_srx_help = ''
    amw_srx_description = ''
    amw_srx_parser = unreal_auto_mod_parser.add_parser(name=amw_srx_name, help=amw_srx_help,
                                                       description=amw_srx_description)
    ...
    amw_sry_help = ''
    amw_sry_description = ''
    amw_sry_parser = unreal_auto_mod_parser.add_parser(name=amw_sry_name, help=amw_sry_help,
                                                       description=amw_sry_description)
    ...
    mod_info_ae_parser = unreal_auto_mod_parser.add_parser(name=mod_info_ae_name, help=mod_info_ae_help,
                                                           description=mod_info_ae_description)
    ...
    mod_info_re_parser = unreal_auto_mod_parser.add_parser(name=mod_info_re_name, help=mod_info_re_help,
                                                           description=mod_info_re_description)
    ...
    mod_info_mn_parser = unreal_auto_mod_parser.add_parser(name=mod_info_mn_name, help=mod_info_mn_help,
                                                           description=mod_info_mn_description)
    ...
    mod_info_pds_parser = unreal_auto_mod_parser.add_parser(name=mod_info_pds_name, help=mod_info_pds_help,
                                                            description=mod_info_pds_description)
    ...
    mod_info_mndt_parser = unreal_auto_mod_parser.add_parser(name=mod_info_mndt_name, help=mod_info_mndt_help,
                                                             description=mod_info_mndt_description)
    ...
    mod_info_mndno_parser = unreal_auto_mod_parser.add_parser(name=mod_info_mndno_name, help=mod_info_mndno_help,
                                                              description=mod_info_mndno_description)
    ...
    mod_info_mndnon_parser = unreal_auto_mod_parser.add_parser(name=mod_info_mndnon_name, help=mod_info_mndnon_help,
                                                               description=mod_info_mndnon_description)
    ...
    mod_info_pcn_parser = unreal_auto_mod_parser.add_parser(name=mod_info_pcn_name, help=mod_info_pcn_help,
                                                            description=mod_info_pcn_description)
    ...
    mod_info_pt_parser = unreal_auto_mod_parser.add_parser(name=mod_info_pt_name, help=mod_info_pt_help,
                                                           description=mod_info_pt_description)
    ...
    mod_info_ct_parser = unreal_auto_mod_parser.add_parser(name=mod_info_ct_name, help=mod_info_ct_help,
                                                           description=mod_info_ct_description)
    ...
    mod_info_ie_parser = unreal_auto_mod_parser.add_parser(name=mod_info_ie_name, help=mod_info_ie_help,
                                                           description=mod_info_ie_description)
    ...
    mod_info_atp_parser = unreal_auto_mod_parser.add_parser(name=mod_info_atp_name, help=mod_info_atp_help,
                                                            description=mod_info_atp_description)
    ...
    mod_info_rat_parser = unreal_auto_mod_parser.add_parser(name=mod_info_rat_name, help=mod_info_rat_help,
                                                            description=mod_info_rat_description)
    ...
    mod_info_aap_parser = unreal_auto_mod_parser.add_parser(name=mod_info_aap_name, help=mod_info_aap_help,
                                                            description=mod_info_aap_description)
    ...
    mod_info_rap_parser = unreal_auto_mod_parser.add_parser(name=mod_info_rap_name, help=mod_info_rap_help,
                                                            description=mod_info_rap_description)
    ...
    test_mods_parser = unreal_auto_mod_parser.add_parser(name=test_mods_name, help=test_mods_help,
                                                         description=test_mods_description)
    ...
    test_mods_all_parser = unreal_auto_mod_parser.add_parser(name=test_mods_all_name, help=test_mods_all_help,
                                                             description=test_mods_all_description)
